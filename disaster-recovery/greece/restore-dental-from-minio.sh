...
restore_n8n() {
  ...
  local run="docker run --rm --user 1000:1000 -e N8N_ENCRYPTION_KEY=$GOMPHA_N8N_ENCRYPTION_KEY -v $BASE/n8n:/home/node/.n8n -v /tmp/gn8nrestore:/restore:ro n8nio/n8n:2.37.1"
